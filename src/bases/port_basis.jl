function raviartthomaswithport(mesh::CompScienceMeshes.AbstractMesh{U,D1,T}, portmesh::CompScienceMeshes.AbstractMesh{U,D2,T},direction::Float64) where {U,D1,D2,T}
...
#= function raviartthomaswithport(mesh::CompScienceMeshes.AbstractMesh{U,D1,T}, portmesh::CompScienceMeshes.AbstractMesh{U,D2,T},direction::Float64, closed::Bool) where {U,D1,D2,T}
...
#= function raviartthomaswithport(dev_mesh::CompScienceMeshes.AbstractMesh{U,D1,T}, port1mesh::CompScienceMeshes.AbstractMesh{U,D2,T}, port2mesh::CompScienceMeshes.AbstractMesh{U,D3,T}, closed::Bool) where{U,D1,D2,D3,T}
    outward = 1.0
    inward = -1.0
    X = raviartthomas(dev_mesh)
    Y = raviartthomaswithport(dev_mesh, port1mesh, outward, closed)
    Z = raviartthomaswithport(dev_mesh, port1mesh, inward, closed)
